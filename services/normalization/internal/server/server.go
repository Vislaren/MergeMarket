// Package server exposes the normalization-service's HTTP surface. Per the
// MergeMarket API contract every service exposes GET /health; this service
// additionally surfaces worker-pool counters under /stats for observability.
package server
...
const serviceName = "normalization-service"
